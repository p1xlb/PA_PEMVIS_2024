...
Public Class Registrasi
    ...
    Private Sub txtRegistrasi_Click_1(sender As Object, e As EventArgs) Handles txtRegistrasi.Click
        If ValidateInput() = True Then
            ...
            If Not RD.HasRows Then
                ...
                CMD = New MySqlCommand("INSERT INTO pelanggan (username, password, nama_pelanggan, nomor_telepon, alamat) VALUES ('" & username & "', '" & password & "', '" & nama & "', '" & no_telp & "', '" & alamat & "')", CONN)
                CMD.ExecuteNonQuery()
