...
Public Class InventoryManager
    ...
    Private Sub rbtnTersedia_CheckedChanged(sender As Object, e As EventArgs)
        status = "tersedia"
    End Sub
    Private Sub rbtnDisewa_CheckedChanged(sender As Object, e As EventArgs)
        status = "disewa"
    End Sub
    Private Sub rbtnDiperbaiki_CheckedChanged(sender As Object, e As EventArgs)
        status = "diperbaiki"
    End Sub
    ...
    Private Sub btnGenID_Click(sender As Object, e As EventArgs) Handles btnGenID.Click
        ...
        ElseIf cbTipeSepeda.SelectedItem = "Honda EM1" Then
            txtKodeSepeda.Text = "EM" & GenerateID()
        End If
    End Sub
    ...
    Private Sub cbTipeSepeda_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbTipeSepeda.SelectedIndexChanged
        ...
        ElseIf cbTipeSepeda.Text = "Crosser VX" Then
            ...
            txtBaterai.Text = "970"
            txtJarak.Text = "60"
        ElseIf cbTipeSepeda.Text = "Honda EM1" Then
            txtTarif.Text = "95000"
            txtBaterai.Text = "1305"
            txtJarak.Text = "75"
        End If
    End Sub
